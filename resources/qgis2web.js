...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [2378052.921765, 5010764.856315, 3374455.070179, 5607694.801934], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
...
map.getView().fit([2378052.921765, 5010764.856315, 3374455.070179, 5607694.801934], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Wildfires in Southwestern Bulgaria</h2>';
        return titleElement;
    })(),
